...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_folder', default='/home/mhbokaei/shakouri/ALLDATA/block/iran/el_gh_ha_ke_ko_ma_se1/run_alltime_zero/test_zero/1/s1_data', type=str,
                        help='Path to the test folder.')
    parser.add_argument('--dataset_folder_meanstd1', default='/home/mhbokaei/shakouri/ALLDATA/block/iran/el_gh_ha_ke_ko_ma_se1/run_alltime_zero/test_zero/1/s1_data', type=str,
                        help='Path to mean-std1.')
    parser.add_argument('--dataset_folder_meanstd2', default='/home/mhbokaei/shakouri/ALLDATA/block/iran/el_gh_ha_ke_ko_ma_se1/run_alltime_zero/test_zero/1/s2_data', type=str,
                        help='Path to mean-std2.')
    parser.add_argument('--weight_dir', default='/home/mhbokaei/shakouri/CropTypeMappinp/weights/el_gh_ha_ke_ko_ma_se1/results_pse_nadam', help='Path to the weight')                    
    ...
    parser.add_argument('--res_dir', default='/home/mhbokaei/shakouri/CropTypeMappinp/multi_sensor/INF_result/rubost/pse_ru1', help='Path to the folder where the results should be stored')
