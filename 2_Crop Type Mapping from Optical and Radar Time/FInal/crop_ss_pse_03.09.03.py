...
if __name__ == '__main__':
    ...
    #/home/mhbokaei/shakouri/ALLDATA/block/iran/el_gh_ha_ke_ko_ma_se1/run_alltime_zero/dataset_zero/1/s1_data
    #/home/mhbokaei/shakouri/ALLDATA/block/iran/el_gh_ha_ke_ko_ma_se1/run_alltime_zero/dataset_zero/1/s1_data
    ...
    parser.add_argument('--res_dir', default='./results_pse_40delet', help='Path to the folder where the results should be stored')
