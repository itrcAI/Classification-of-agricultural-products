...
if __name__ == '__main__':
    ...
    parser.add_argument('--fusion_type', default='softmax_norm', type=str,
    ...
    parser.add_argument('--mlp4', default='[128, 64, 32, 19]', type=str, help='Number of neurons in the layers of MLP4- pse and tae nedd 256 except 128')
