...
def main(args):
    ...
    for _, (train_loader, val_loader, test_loader) in enumerate(loaders):
        ...
        for param in model.spatial_encoder_s1.parameters(): 
         param.requires_grad = False

        for param in model.spatial_encoder_s2.parameters(): 
         param.requires_grad = False

        #for param in model.temporal_encoder_pseFusion.parameters(): 
        # param.requires_grad = False
...
if __name__ == '__main__':
    ...
    #/home/mhbokaei/shakouri/ALLDATA/block/iran/el_gh_ha_ke_ko_ma_se1/run_alltime/dataset_folder/s1_data
    #/home/mhbokaei/shakouri/ALLDATA/block/iran/el_gh_ha_ke_ko_ma_se1/run_alltime/val_folder/s1_data
    #/home/mhbokaei/shakouri/ALLDATA/block/iran/el_gh_ha_ke_ko_ma_se1/run_alltime/test_folder/s1_data
    ...
    # Set-up parameters
    parser.add_argument('--dataset_folder', default='/home/mhbokaei/shakouri/ALLDATA/block/iran/test_senario/train_el_gh_ha_ko_test_ke_ma_se1/post_ke_ma/run_40pers_delet/dataset_folder/s1_data', type=str,
    ...
    parser.add_argument('--val_folder', default='/home/mhbokaei/shakouri/ALLDATA/block/iran/test_senario/train_el_gh_ha_ko_test_ke_ma_se1/post_ke_ma/run_40pers_delet/val_folder/s1_data', type=str,
                        help='Path to the validation folder.')
    parser.add_argument('--test_folder', default='/home/mhbokaei/shakouri/ALLDATA/block/iran/test_senario/train_el_gh_ha_ko_test_ke_ma_se1/post_ke_ma/run_40pers_delet/test_folder/s1_data', type=str,
                        help='Path to the test folder.')
    parser.add_argument('--dataset_folder_meanstd1', default='/home/mhbokaei/shakouri/ALLDATA/block/iran/test_senario/train_el_gh_ha_ko_test_ke_ma_se1/post_ke_ma/run_40pers_delet/dataset_folder/s1_data', type=str,
                        help='Path to mean-std1.')
    parser.add_argument('--dataset_folder_meanstd2', default='/home/mhbokaei/shakouri/ALLDATA/block/iran/test_senario/train_el_gh_ha_ko_test_ke_ma_se1/post_ke_ma/run_40pers_delet/dataset_folder/s2_data', type=str,
                        help='Path to mean-std2.')
    parser.add_argument('--res_dir_WE', default='/home/mhbokaei/shakouri/CropTypeMappinp/weights/train_el_gh_ha_ko_test_ke_ma_se1/results_psa', help='Path to the folder where the results should be stored')
    ...
    parser.add_argument('--res_dir', default='./results_TL_psa_psa_40delet', help='Path to the folder where the results should be stored')
