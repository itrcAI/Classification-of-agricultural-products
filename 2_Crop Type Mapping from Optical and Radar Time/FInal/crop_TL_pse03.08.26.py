...
if __name__ == '__main__':
    ...
    # Set-up parameters
    parser.add_argument('--dataset_folder', default='/home/mhbokaei/shakouri/ALLDATA/block/iran/test_senario/train_el_gh_ha_ko_test_ke_ma_se1/post_ke_ma/run_alltime/dataset_folder/s1_data', type=str,
    ...
    parser.add_argument('--val_folder', default='/home/mhbokaei/shakouri/ALLDATA/block/iran/test_senario/train_el_gh_ha_ko_test_ke_ma_se1/post_ke_ma/run_alltime/val_folder/s1_data', type=str,
                        help='Path to the validation folder.')
    parser.add_argument('--test_folder', default='/home/mhbokaei/shakouri/ALLDATA/block/iran/test_senario/train_el_gh_ha_ko_test_ke_ma_se1/post_ke_ma/run_alltime/test_folder/s1_data', type=str,
                        help='Path to the test folder.')
    parser.add_argument('--dataset_folder_meanstd1', default='/home/mhbokaei/shakouri/ALLDATA/block/iran/test_senario/train_el_gh_ha_ko_test_ke_ma_se1/post_ke_ma/run_alltime/dataset_folder/s1_data', type=str,
                        help='Path to mean-std1.')
    parser.add_argument('--dataset_folder_meanstd2', default='/home/mhbokaei/shakouri/ALLDATA/block/iran/test_senario/train_el_gh_ha_ko_test_ke_ma_se1/post_ke_ma/run_alltime/dataset_folder/s2_data', type=str,
    ...
    parser.add_argument('--res_dir', default='./results_TL_psa_pse', help='Path to the folder where the results should be stored')
