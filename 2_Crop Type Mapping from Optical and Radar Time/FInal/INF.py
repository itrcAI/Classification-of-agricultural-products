...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_folder', default='/home/mhbokaei/shakouri/ALLDATA/block/iran/ellam_se1/run_alltime/test_folder/s1_data', type=str,
    ...
    parser.add_argument('--weight_dir', default='/home/mhbokaei/shakouri/CropTypeMappinp/multi_sensor/results_pse_nadam/', help='Path to the weight')                    
    ...
    parser.add_argument('--res_dir', default='/home/mhbokaei/shakouri/CropTypeMappinp/multi_sensor/FINAL_INF/PSE_NADAM/ellam', help='Path to the folder where the results should be stored')
