...
if __name__ == '__main__':
    ...
    # Set-up parameters
    parser.add_argument('--dataset_folder', default='/home/mhbokaei/shakouri/ALLDATA/block/iran/el_gh_ha_ke_ko_ma_se1/run_alltime/dataset_folder/s1_data', type=str,
    ...
    parser.add_argument('--val_folder', default='/home/mhbokaei/shakouri/ALLDATA/block/iran/el_gh_ha_ke_ko_ma_se1/run_alltime/val_folder/s1_data', type=str,
                        help='Path to the validation folder.')
    parser.add_argument('--test_folder', default='/home/mhbokaei/shakouri/ALLDATA/block/iran/kordestan_se1/run_alltime/test_folder/s1_data', type=str,
                        help='Path to the test folder.')
    parser.add_argument('--dataset_folder_meanstd1', default='/home/mhbokaei/shakouri/ALLDATA/block/iran/el_gh_ha_ke_ko_ma_se1/run_alltime/dataset_folder/s1_data', type=str,
                        help='Path to mean-std1.')
    parser.add_argument('--dataset_folder_meanstd2', default='/home/mhbokaei/shakouri/ALLDATA/block/iran/el_gh_ha_ke_ko_ma_se1/run_alltime/dataset_folder/s2_data', type=str,
    ...
    parser.add_argument('--res_dir', default='./results_psa_KO_SMAL', help='Path to the folder where the results should be stored')
