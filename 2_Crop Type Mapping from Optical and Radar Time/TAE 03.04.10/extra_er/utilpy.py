...
# %%
#data_len("/home/mhbokaei/shakouri/test/Satellite/Alldata/dataset_folder")

# %%
#data_check("/home/mhbokaei/shakouri/SatelliteImage_TimeSeries_Classification/dataset_folder")
...
#listt =[]
#dim = 2
#source = r"C:\Users\HA\Desktop\e\RS\CropTypeMapping-main\multi_sensor\dataset_folder\DATA"
#save = r"C:\Users\HA\Desktop\e\RS\CropTypeMapping-main\multi_sensor\dataset_result\DATA"
#remove_dimension(dim,listt,source,save)

# %%
#data1 = np.load(r"C:\Users\HA\Desktop\e\RS\sattelate\dataset_folder\DATA\5.npy")
#print("data1.shape: ",data1.shape)
...
#listt =[1,5,9,14,21]
#dim = 0
#source = r"C:\Users\HA\Desktop\e\RS\sattelate\S2-2017-T31TFM-meanstd.pkl"
#save = r"C:\Users\HA\Desktop\e\RS\sattelate\resultTest"
#remove_dimension_pkl(dim,listt,source,save)



# %%
preLoad_pkl = pkl.load(open("/home/mhbokaei/shakouri/CropTypeMappinp/multi_sensor/All_dataset/dataset_100/test_folder/s2_data/S2-2017-T31TFM-meanstd.pkl", 'rb'))
