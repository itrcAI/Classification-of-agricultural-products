...
def main(args):
    ...
    prepare_output(args)
    mean_std = pkl.load(open(args['dataset_folder'] + '/mean_std_s2.pkl', 'rb'))
    mean_std_sepT = pkl.load(open(args['dataset_folder_sepT'] + '/mean_std_s2.pkl', 'rb'))
...
if __name__ == '__main__':
    ...
    # /home/mhbokaei/shakouri/ALLDATA/block/iran/29000_030605/SA/S2/train
    # 
    
    parser.add_argument('--dataset_folder', default='/home/mhbokaei/shakouri/ALLDATA/block/iran/29000_030605/SA/S2/train', type=str,
                        help='Path to the folder where the results are saved.')
    parser.add_argument('--dataset_folder_sepT', default='/home/mhbokaei/shakouri/ALLDATA/block/iran/29000_030605/SA/S2/test', type=str,
                        help='Path to the folder where the results are saved.')
    parser.add_argument('--separate_test', default='yes', type=str, help='Shows the dataset for Test is different(no  yes)')

    parser.add_argument('--res_dir', default='./results_s2', help='Path to the folder where the results should be stored')
    ...
    ## PSE
    parser.add_argument('--input_dim', default=17, type=int, help='Number of channels of input images')
