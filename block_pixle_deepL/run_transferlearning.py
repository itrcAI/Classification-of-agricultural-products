...
def run_transferlearning(train_path:str, validation_path:str, test_path:str, mean_std_s1_path:str, mean_std_s2_path:str, weight_path:str, save_result_path:str,
    ...
    if __name__ == '__main__':
        ...
        parser.add_argument('--res_dir_WE', default=weight_path, help='Path to the folder where the results should be stored')
